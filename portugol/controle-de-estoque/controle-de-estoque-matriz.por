programa
{
	...
	inteiro opcao, posicao=0, repeticao, relatorio[4][quant],  
	...
	funcao saldo()
	{
		para(inteiro l=0; l < 2; l++)
		{
			...
			{
				escreva("\n produto: ",veic[l], " saldo ", relatorio[3][c], "entrada: ", relatorio[1][c], "saida: ", relatorio[2][c])
			}	
		}
		escreva("||--------------------------------------||")
		escreva("\n||Pressione a tecla [enter] para continuar: ||")
